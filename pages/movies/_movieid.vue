<template>
   ...
   <div v-else class="single-movie">
      ...
      >
        ...
        <div class="w-full md:w-[70%] mx-auto grid grid-cols-5 justify-center items-end gap-4 md:gap-8 -mt-12 z-10 inset-x-0 " >
            <img
         ...
         <p class="text-xl tracking-wider text-white font-semibold mt-6">Overview</p>
