<template>
   ...
   <div v-else class="single-movie">
      <div class="container absolute top-6 inset-x-0 z-10">
         <nuxt-link :to="{ name: 'index' }" class="btn-prev">
            <font-awesome-icon :icon="['fas', 'fa-chevron-left']" />
         </nuxt-link>
      </div>

      <div class="w-full h-[40vh] lg:h-[60vh]">
         <img :src="`https://image.tmdb.org/t/p/original/${movie.backdrop_path}`" alt=""
            class="object-cover w-full h-[40vh]" />
         <span class="bg-gradient-to-t from-gray-900 absolute object-cover w-full h-[40vh] top-0"></span>
      </div>

      <div
         class="w-full md:w-[70%] container relative mx-auto grid grid-cols-5 justify-center items-end gap-4 md:gap-8 -mt-12 z-10 inset-x-0">
         ...
         <div class="col-span-3 pt-8 pb-4">
            ...
            <p class="px-2 py-[2px] text-xs my-2 bg-red-600 text-white rounded-md inline-block">
               {{ movie.vote_average }}
            </p>
